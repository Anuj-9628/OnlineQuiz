...
class Test extends JFrame implements ActionListener
{
	...
	Test(){
		c=new JFrame("welcome TO MY QUIZ");
		c.setVisible(true);
		c.setBounds(100,50,1000,700);
		...
		b1=new JButton("NEXT");
		b.setSize(100,50);
		b.setLocation(900,600);
	 	b1.setSize(100,50);
		b1.setLocation(1200,600);
		c.add(b);
		c.add(b1);
b1.addActionListener(this);
		...
		j.setBounds(300,300,500,30);
		j1.setBounds(280,350,500,30);
        ...
        c.add(j1);
		 ...
		 Font f2=new Font("Arial",Font.BOLD,15);
		  t.setFont(f2);
           t.setBounds(400,305,250,25);
           t1.setBounds(400,350,250,25);
          c.add(t);
          c.add(t1);	  
